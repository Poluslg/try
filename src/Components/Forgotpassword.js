            ...
            <div className="w-full max-w-md space-y-8">
              ...
              <div className="btnc">
                <button
                  type="submit"
                  onClick={Submit}
                  className="group relative flex w-full justify-center rounded-md border  bg-slate-600 py-2 px-4 text-sm font-medium text-white hover:bg-fuchsia-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  Submit{" "}
                </button>
                <button
